...
{prefix}dns_request_type_count_total{server="{server}",type="A",zone="{zone}"} {request_type_count_total_a}
{prefix}dns_request_type_count_total{server="{server}",type="AAAA",zone="{zone}"} {request_type_count_total_aaaa}
{prefix}dns_request_type_count_total{server="{server}",type="NS",zone="{zone}"} {request_type_count_total_ns}
{prefix}dns_request_type_count_total{server="{server}",type="PTR",zone="{zone}"} {request_type_count_total_ptr}
{prefix}dns_request_type_count_total{server="{server}",type="SRV",zone="{zone}"} {request_type_count_total_srv}
{prefix}dns_request_type_count_total{server="{server}",type="CNAME",zone="{zone}"} {request_type_count_total_cname}
{prefix}dns_request_type_count_total{server="{server}",type="SOA",zone="{zone}"} {request_type_count_total_soa}
{prefix}dns_request_type_count_total{server="{server}",type="MX",zone="{zone}"} {request_type_count_total_mx}
{prefix}dns_request_type_count_total{server="{server}",type="TXT",zone="{zone}"} {request_type_count_total_txt}
{prefix}dns_response_rcode_count_total{rcode="NOERROR",server="{server}",zone="{zone}"} {response_rcode_count_total_noerror}
{prefix}dns_response_rcode_count_total{rcode="FORMERR",server="{server}",zone="{zone}"} {response_rcode_count_total_formerr}
{prefix}dns_response_rcode_count_total{rcode="SERVFAIL",server="{server}",zone="{zone}"} {response_rcode_count_total_servfail}
{prefix}dns_response_rcode_count_total{rcode="NXDOMAIN",server="{server}",zone="{zone}"} {response_rcode_count_total_nxdomain}
{prefix}dns_response_rcode_count_total{rcode="NOTIMP",server="{server}",zone="{zone}"} {response_rcode_count_total_notimp}
{prefix}dns_response_rcode_count_total{rcode="REFUSED",server="{server}",zone="{zone}"} {response_rcode_count_total_refused}
{prefix}dns_response_rcode_count_total{rcode="YXDOMAIN",server="{server}",zone="{zone}"} {response_rcode_count_total_yxdomain}
{prefix}dns_response_rcode_count_total{rcode="XRRSET",server="{server}",zone="{zone}"} {response_rcode_count_total_xrrset}
{prefix}dns_response_rcode_count_total{rcode="NOTAUTH",server="{server}",zone="{zone}"} {response_rcode_count_total_notauth}
{prefix}dns_response_rcode_count_total{rcode="NOTZONE",server="{server}",zone="{zone}"} {response_rcode_count_total_notzone}
